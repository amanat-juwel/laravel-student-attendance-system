...
<!-- End Content Header -->
<!-- Main content -->
<form action="{{url('send/sms/students')}}" method="post" id="smsForm">
{{ csrf_field() }}
<div class="row">
    <div class="col-sm-4">
        <section class="content">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="radio">
                      <label><input type="radio" id="" value="to_all" name="optradio" checked>To All Student</label>
                    </div>
                    <hr>
                    <div class="radio">
                      <label><input type="radio" id="" value="class_section" name="optradio">Class & Section</label>
                          <div class="cls_sec">
                    ...
                    <hr>
                    <div class="radio">
                      <label><input type="radio"  value="van_student" name="optradio">Van Student</label>
