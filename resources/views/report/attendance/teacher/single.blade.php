...
<section class="content">
    <div class="panel panel-default">
        <div class="panel-body">
            <form class="form" action="{{ url('report/teacher/single') }}" name="myForm" id="date_form" method="post">
                {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <select name="teacher_id" class="form-control select2" required>
                            <option value="">--- Choose ---</option>
                                ...
                                <option value="{{ $data->id }}" @if(isset($teacher)) @if($teacher->id == $data->id) selected @endif @endif >{{ $data->name }}</option>
                                @endforeach
                        </select>
                        </div>
                    </div>    
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                    ...
                    @if(isset($start_date))
                    <br>
                    <a class="btn btn-warning btn-xs pull-right" href="{{ url('/report/teacher/single/print/'.$teacher->id.'/'.$start_date.'/'.$end_date) }}" target="_blank">Print/Download as PDF</a>     
                    @endif
                    </div>
                </div> 
