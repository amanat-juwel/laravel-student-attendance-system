...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form" action="{{ url('report/student/single/datewise') }}" name="myForm" id="date_form" method="post">
                {!! csrf_field() !!}
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    PRESENT STUDENTS ON {{ date('F d, Y', strtotime($reporting_date)) }} ; Present: {{ count($attendances)}} ; Absent: {{ count($students)-count($attendances)}}
                </div>
